// src/Pages/ProductDetail/ProductDetailMainContent.tsx
...
const ProductDetailMainContent: React.FC<ProductDetailMainContentProps> = ({
  product,
}) => {
  ...
  return (
    <ProductSection>
      ...
      <SubTitle className="font-semibold text-black">
        {product.saleName}
      </SubTitle>
      ...
      <div className="my-7 py-6 bg-[#fafafc] rounded-2xl px-8">
        ...
        <div className="flex flex-wrap space-x-8 justify-start">
          <Button
            ...
            className="rounded-full mt-2 overflow-clip text-start"
            size={"sm"}
          >
          ...
          <InfoItem>
            {origin ? (
              <>
                <img
                  loading="lazy"
                  src={`/images/Origin/${origin.imagePath}`}
                  alt={origin.name}
                  className="size-16 mb-1"
                />
